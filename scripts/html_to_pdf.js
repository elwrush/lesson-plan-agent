 ...
 * 
 * Usage: node html_to_pdf.js <input_html_path> [output_pdf_path]
 */
...
if (args.length === 0) {
    console.log('Usage: node html_to_pdf.js <input_html_path> [output_pdf_path]');
    console.log('Example: node html_to_pdf.js worksheet.html worksheet.pdf');
    process.exit(1);
}
