...
## The Tool: `scripts/trim_image.py`
Use this script to auto-process images.

### Usage
```bash
python scripts/trim_image.py <input> <output> [options]
```
...
python scripts/trim_image.py "images/generated_title.jpg" "images/header_final.png" --padding 10 --threshold 230 --transparent
```
...
2.  Trim and transparentize:
    ```bash
    python scripts/trim_image.py "images/separator_raw.jpg" "images/separator.png" --padding 0 --threshold 220 --transparent
    ```
